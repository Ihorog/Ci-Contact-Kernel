...
- Поточна LAN-адреса, зафіксована під час аудиту: `192.168.1.132` (адреса змінна; ідентичність вузла не залежить від IP).
...
| Локальний UI `:8080/health` | HTTP 200 |
| Cimeika API `:8000/health` | HTTP 200 |
| MCP `:8797/` | HTTP 200 |
| `https://orange.cimeika.com.ua/` | HTTP 200 |
